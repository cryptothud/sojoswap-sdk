...
export declare class Pair {
    ...
    static getAddress(tokenA: Token, tokenB: Token, config: FACTORY_CONFIG): string;
    constructor(currencyAmountA: CurrencyAmount<Token>, tokenAmountB: CurrencyAmount<Token>, config: FACTORY_CONFIG);
    /**
    ...
    getOutputAmount(inputAmount: CurrencyAmount<Token>, config: FACTORY_CONFIG): [CurrencyAmount<Token>, Pair];
    getInputAmount(outputAmount: CurrencyAmount<Token>, config: FACTORY_CONFIG): [CurrencyAmount<Token>, Pair];
